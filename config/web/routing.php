...
$config = array(
    ...
    'routing' => array(
        ...
        _('braves') . '/pro/{param1}/{param2}/{param3}/{param4}'          => 'Potato\\Map',
        _('braves') . '/pro/{param1}/{param2}/{param3}/{param4}/{param5}' => 'Potato\\Map',
        _('braves') . '/{param1}'                                         => 'Potato\\Map',
        _('braves') . '/{param1}/{param2}'                                => 'Potato\\Map',
        _('braves') . '/{param1}/{param2}/{param3}'                       => 'Potato\\Map',
        _('braves') . '/{param1}/{param2}/{param3}/{param4}'              => 'Potato\\Map',
